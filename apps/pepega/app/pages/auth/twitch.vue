  ...
  <div :class="$style.component">
    <div :class="$style.content">
      <div :class="$style.progress">
        <div v-if="isFailed" :class="$style.icon">💀</div>

        <FidgetSpinner v-else size="32px" />
      </div>

      <div v-if="isFailed">Failed to connect <strong>Twitch</strong></div>

      <div v-else>Connecting <strong>Twitch</strong>...</div>

      <!-- TODO: style this link -->
      <NuxtLink v-if="isFailed" to="/"> Return to Home </NuxtLink>
    </div>
  </div>
</template>
