<template>
  <PageBase title="Stream Online notifications">
    <LoadingState v-if="isNotificationPending"> Loading notifications... </LoadingState>

    <div v-else-if="notification.data" :class="$style.cards">
      <BaseCard :class="$style.card">
        <section :class="$style.formSection">
          ...
          <fieldset :class="$style.fieldset">
            ...
            <SimpleButton :disabled="isSubmitDisabled" @click="onCreateNotificationClick">
              Create notification
            </SimpleButton>
          </fieldset>
        </section>
...
const isSubmitDisabled = computed(
  () => isMessageFieldDisabled.value || isCreatingNotification.value,
);
