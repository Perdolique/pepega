<template>
  <BaseCard :class="$style.card">
    <div :class="$style.header">
      <div :class="$style.title">Stream online</div>
    ...
    <div :class="$style.description">Get notified when your stream goes live</div>
    ...
    <div :class="$style.buttons">
      ...
      <LinkButton to="/settings/notifications/stream-online" icon-name="tabler:settings">
        Settings
      </LinkButton>
    </div>
  </BaseCard>
...
const { pause: stopStatusPolling, resume: startStatusPolling } = useTimeoutPoll(
  async () => {
