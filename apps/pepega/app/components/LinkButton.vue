<template>
  <NuxtLink :to="to" :external="external" :target="target" :class="[$style.component, variant]">
    <Icon v-if="iconName" :class="$style.icon" :name="iconName" />
...
const { variant = 'primary', external = false, target } = defineProps<Props>();
</script>
